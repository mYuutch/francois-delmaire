...
<div className="container flex flex-col gap-24 mx-auto h-full">
  ...
  <div className="">
    ...
    <span className="max-md:text-lg text-2xl text-white ">François Delmaire - 4 étoiles</span>
